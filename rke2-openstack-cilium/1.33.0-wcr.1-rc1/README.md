...
helm install rke2-openstack-cilium-1.33.0-wcr.1-rc1.tgz -f custom-values.yaml .
...
|-----|------|---------|-------------|
| cluster | object | `{"addonsRepoCredentials":{"secret":{"name":"oci-whitecruiser-marketplace","namespace":"fleet-default"}},"annotations":{},"apiServerVIP":"<changeme>","etcd":{"backup":{"disableAutomaticSnapshots":true},"exposeMetrics":false,"extraArgs":[]},"kubeComponents":{"kubeApiServer":{"extraArgs":[]},"kubeControllerManager":{"extraArgs":[]},"kubeProxy":{"extraArgs":[]},"kubeShceduler":{"extraArgs":[]},"kubelet":{"extraArgs":[]}},"labels":{},"name":"prod-cluster"}` | RKE2 cluster core configuration |
| cluster.apiServerVIP | string | `"<changeme>"` | Virtual IP address for the Kubernetes API server (load balancer endpoint) |
